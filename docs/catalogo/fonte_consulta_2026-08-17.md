# Registro de consulta de fontes oficiais

Data da consulta: 2026-08-17.

## Código Penal

A página oficial do Planalto foi aberta com sucesso em <https://www.planalto.gov.br/ccivil_03/decreto-lei/del2848.htm>. O cabeçalho identifica o Decreto-Lei nº 2.848, de 7 de dezembro de 1940, como **texto compilado** e **vigência**. A página contém o Código Penal e notas de alterações legislativas, servindo como fonte primária para os tipos do Código Penal.

## Lei das Contravenções Penais

A URL oficial esperada é <https://www.planalto.gov.br/ccivil_03/decreto-lei/del3688.htm>. Na consulta realizada, o Planalto respondeu com uma página de acesso negado, com código de bloqueio `13376840595500211791`. A fonte deve permanecer registrada como oficial, mas sua conferência automática está pendente até nova consulta ou validação por outra fonte oficial estável.

## Regra de uso

O catálogo não deve marcar um registro como juridicamente conferido apenas porque a URL existe. A data, o estado da conferência e eventuais bloqueios devem ser registrados separadamente.

## Leis penais especiais

A consulta da Lei nº 15.358/2026, em <https://www.planalto.gov.br/ccivil_03/_ato2023-2026/2026/lei/l15358.htm>, foi bloqueada pelo Planalto com código `13376840595560440366`. A própria busca oficial indicou que a lei acrescenta o art. 40-A à Lei nº 11.343/2006 e altera tipos do Código Penal e de outras leis. Por isso, mudanças de 2026 devem ser tratadas como fonte recente que exige conferência específica, sem inferência automática.

A versão compilada do Estatuto do Desarmamento foi aberta com sucesso em <https://www.planalto.gov.br/ccivil_03/leis/2003/l10.826compilado.htm>. A página oficial apresentou, entre outros, os arts. 12 a 18: posse irregular de arma de fogo de uso permitido (1 a 3 anos e multa), omissão de cautela (1 a 2 anos e multa), porte ilegal de uso permitido (2 a 4 anos e multa), disparo de arma de fogo (2 a 4 anos e multa), posse ou porte de uso restrito (3 a 6 anos e multa), comércio ilegal (6 a 12 anos e multa) e tráfico internacional (8 a 16 anos e multa). Esses registros podem integrar a carga inicial com fonte oficial e data de conferência.

## Drogas e lavagem

A página oficial da Lei nº 11.343/2006 foi aberta em <https://www.planalto.gov.br/ccivil_03/_ato2004-2006/2006/lei/l11343.htm> como texto compilado. O conteúdo consultado confirmou o art. 33, com pena de reclusão de 5 a 15 anos e 500 a 1.500 dias-multa, e o art. 35, com pena de reclusão de 3 a 10 anos e 700 a 1.200 dias-multa.

A consulta da página compilada da Lei nº 9.613/1998, em <https://www.planalto.gov.br/ccivil_03/leis/l9613compilado.htm>, foi bloqueada pelo Planalto com código `13376840595560463310`. Embora a URL seja oficial, a conferência automática do tipo de lavagem deve permanecer pendente até consulta bem-sucedida ou validação em outra fonte oficial.
...
## Auditoria provisória — sonegação fiscal

A Lei nº 4.729/1965 foi consultada na fonte oficial <https://www.planalto.gov.br/ccivil_03/leis/1950-1969/l4729.htm>. O art. 1º descreve cinco condutas sob o rótulo de sonegação fiscal e prevê detenção de 6 meses a 2 anos e multa de 2 a 5 vezes o valor do tributo; os §§ 1º a 3º trazem redução ou aumentos de pena. O texto oficial remete à Lei nº 8.137/1990, mas não basta, isoladamente, para concluir se o art. 1º permanece como tipo autônomo vigente ou se foi materialmente substituído pelos arts. 1º e 2º da Lei nº 8.137/1990. Por isso, nenhum registro novo foi criado neste checkpoint; a pendência exige reconciliação normativa e jurisprudencial oficial antes do cadastro, evitando duplicidade ou inclusão de tipo sem vigência confirmada.

Os arts. 2º e 9º aparecem revogados no próprio texto oficial e não integram a coleção ativa. O art. 5º promoveu alteração histórica do art. 334 do Código Penal e não deve gerar registro autônomo na Lei nº 4.729/1965.

## Cobertura nacional — Lei Maria da Penha

A Lei nº 11.340/2006 foi consultada no texto oficial compilado do Planalto em <https://www.planalto.gov.br/ccivil_03/_ato2004-2006/2006/lei/l11340.htm>. O capítulo penal contém o art. 24-A, que tipifica o descumprimento de decisão judicial que defere medidas protetivas de urgência. A redação vigente exibida na fonte, dada pela Lei nº 14.994/2024, prevê reclusão de 2 a 5 anos e multa; a pena anterior de detenção aparece como redação histórica. O § 4º, incluído pela Lei nº 15.383/2026, prevê causa de aumento e foi preservado como enriquecimento futuro, não como tipo autônomo. Foi cadastrado um registro ativo, ainda pendente de inventário e enriquecimento.

## Cobertura nacional — Estatuto do Desarmamento

A versão compilada da Lei nº 10.826/2003 foi consultada em <https://www.planalto.gov.br/ccivil_03/leis/2003/l10.826compilado.htm>. O catálogo já possuía os sete tipos-base dos arts. 12 a 18 no módulo **Armas**, com conferência anterior; a reconciliação desta consulta confirmou suas penas vigentes. Foi acrescentada a figura autônoma do art. 16, § 2º, quando as condutas envolverem arma de fogo de uso proibido, com pena própria de reclusão de 4 a 12 anos e multa, vinculada ao tipo-base do art. 16. As condutas do art. 16, § 1º, os parágrafos únicos dos arts. 13, 17 e 18 e os arts. 19, 20 e 21-A foram mantidos como qualificações, equiparações, majorantes ou regras de consequência, não como duplicações de tipos sem pena própria independente.

## Cobertura nacional — Código Penal: crimes contra a pessoa, honra e liberdade

A fonte oficial do Código Penal foi consultada em <https://www.planalto.gov.br/ccivil_03/decreto-lei/del2848.htm>. Foi extraído um lote complementar dos arts. 134 a 154-A: exposição ou abandono de recém-nascido, omissão de socorro, condicionamento de atendimento emergencial, maus-tratos, rixa, crimes contra a honra, constrangimento ilegal, bullying e cyberbullying, perseguição, violação de domicílio, crimes de correspondência, divulgação de segredo, informação sigilosa da Administração Pública e violação de segredo profissional. Figuras qualificadas com pena própria foram separadas e vinculadas aos tipos-base; majorantes e regras de ação penal permaneceram no enriquecimento ou nas observações.

As penas vigentes alteradas pelas Leis nº 14.811/2024, nº 15.123/2025 e nº 15.163/2025 foram registradas conforme o texto oficial. Os arts. 153 e 154 ainda exibem multas históricas em réis na redação compilada, embora haja remissão à Lei nº 7.209/1984; por prudência, esses registros permanecem pendentes e bloqueados para cálculo até normalização segura da sanção pecuniária.

## Cobertura nacional — Código Penal: crimes patrimoniais
...
## Auditoria de fonte — Código Penal: crimes sexuais dos arts. 215 a 218-C

A fonte oficial do Código Penal (<https://www.planalto.gov.br/ccivil_03/decreto-lei/del2848.htm>) foi lida nos arts. 215 a 218-C. O texto vigente confirma violação sexual mediante fraude (art. 215), importunação sexual (art. 215-A), assédio sexual (art. 216-A), registro não autorizado da intimidade sexual (art. 216-B), induzimento à satisfação da lascívia de outrem (art. 218), satisfação de lascívia mediante presença de criança ou adolescente (art. 218-A), favorecimento da exploração sexual de vulnerável (art. 218-B) e divulgação de cena de estupro, sexo, nudez ou pornografia (art. 218-C). As penas vigentes alteradas pela Lei nº 15.280/2025 foram registradas no apontamento de auditoria; os arts. 216, 217 e figuras antigas de rapto aparecem expressamente revogados e permanecem fora da coleção ativa. As disposições de aumento, consentimento, presunção e efeitos da condenação não são tipos autônomos.

## Auditoria de fonte — Código Penal: perigo comum, transportes e serviços públicos

A fonte oficial confirmou os arts. 250 a 266 do Código Penal: incêndio, explosão, uso de gás tóxico, explosivos, inundação, desabamento, material de salvamento, difusão de doença ou praga, perigo e desastre ferroviário, atentados contra transportes marítimos, fluviais, aéreos e outros meios públicos, arremesso de projétil, segurança de serviços de utilidade pública e interrupção de serviços telegráficos, telefônicos, informáticos, telemáticos ou de informação de utilidade pública. As modalidades culposas e os resultados com pena própria foram separadas; regras gerais do art. 258 e aumentos por circunstâncias específicas ficaram fora da contagem.

O art. 264, parágrafo único, possui pena remissiva para o homicídio culposo com aumento de um terço na hipótese de morte; esse registro permanece sem faixa numérica e bloqueado para cálculo. Os arts. 263, 258 e 285 são regras de aplicação ou qualificação, não tipos autônomos, e não foram cadastrados como registros independentes.
